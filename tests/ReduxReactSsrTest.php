...
class ReactReduxSsrTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $reactBundleJs = file_get_contents(__DIR__ . '/builds/reduxV0.1/build/react.bundle.js');
        $appBundleJs = file_get_contents(__DIR__ . '/builds/reduxV0.1/build/app.bundle.js');
